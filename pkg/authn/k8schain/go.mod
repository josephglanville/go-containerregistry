...
require (
	github.com/awslabs/amazon-ecr-credential-helper/ecr-login v0.0.0-20230424191942-9b6e5bb01bd7
	github.com/chrismellard/docker-credential-acr-env v0.0.0-20230304212654-82a0ddb27589
	github.com/google/go-containerregistry v0.14.0
	github.com/google/go-containerregistry/pkg/authn/kubernetes v0.0.0-20230424125553-58bd35bc13f2
	k8s.io/api v0.27.1
